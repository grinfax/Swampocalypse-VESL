    ...
    <section id="media" className="relative py-24 px-4">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="flex justify-center">
          <div 
            ref={containerRef}
            className="relative max-w-3xl w-full group/video rounded-xl overflow-hidden border-2 border-primary/50 shadow-[0_0_20px_hsl(35,100%,50%,0.3)] hover:shadow-[0_0_30px_hsl(35,100%,50%,0.5)] transition-all duration-300 bg-black"
